...
describe("LayerVersionsRequest", function () {
    ...
    it("Should set version", function () {
        const layerVersionsRequest = new LayerVersionsRequest();
        const layerVersionsRequestWithVersion =
            layerVersionsRequest.withVersion(mockedVersion1);
        const layerVersionsRequestWithBillTag =
            layerVersionsRequest.withBillingTag(billingTag);
