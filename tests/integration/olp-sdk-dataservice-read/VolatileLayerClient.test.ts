...
describe("VolatileLayerClient", function () {
    ...
    it("Shoud be fetched partitions metadata for specific IDs", async function () {
        ...
        const partitions = await layerClient
    ...
    it("Shoud read partitions with additionalFields parameter from PartitionsRequest", async function () {
        ...
        const requestWithAdditionalFields =
    ...
    it("Shoud read partitions with additionalFields parameter from QuadKeyPartitionsRequest", async function () {
        ...
        const quadKeyPartitionsRequestWithQuadKey =
            quadKeyPartitionsRequest.withQuadKey(mockedQuadKey);
        const quadKeyPartitionsRequestWithAdditionalFields =
    ...
    it("GetAggregatedData", async function () {
        ...
        mockedResponses.set(
            `https://query.data.api.platform.here.com/hrn:here:data:::test-hrn/v1/layers/mocked-layer/quadkeys/24414/depths/4`,
            new Response(
         ...
         * 4 - blob
         */
        expect(fetchStub.mock.calls.length).to.be.equal(4);
    });
});
