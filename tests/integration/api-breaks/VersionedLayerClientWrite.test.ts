...
describe("VersionedLayerClient", function () {
    ...
    it("checkDataExists method", async function () {
        layerClient
            .checkDataExists(new CheckDataExistsRequest())
            .catch((e) => e);
        layerClient
    ...
    it("getBaseVersion method", async function () {
        ...
        layerClient
            .getBaseVersion("mocked-billing-tag", abortSignal)
            .catch((e) => e);
    });
    it("startBatch method", async function () {
        layerClient.startBatch(new StartBatchRequest()).catch((e) => e);
        layerClient
            .startBatch(new StartBatchRequest(), abortSignal)
            .catch((e) => e);
    });
    ...
    it("getBatch method", async function () {
        ...
        layerClient
            .getBatch(new GetBatchRequest(), abortSignal)
            .catch((e) => e);
    });
    ...
    it("uploadBlob method", async function () {
        ...
        layerClient
            .uploadBlob(new UploadBlobRequest(), abortSignal)
            .catch((e) => e);
    });
    it("uploadPartitions method", async function () {
        layerClient
            .uploadPartitions(new UploadPartitionsRequest())
            .catch((e) => e);
        layerClient
