  ...
  it("Should fetch the schema details", async () => {
    ...
    const mockedResponse = {
        artifacts: [
          {
            ...
            hrn: "hrn:here:artifact::realm:com.here.rib.schema:topology-geometry_v1",
            updated: {},
            version: "1.0.0"
          }
        ],
        schema: {
          ...
          groupId: "com.here.rib.schema",
          hrn: "hrn:here:schema::realm:com.here.rib.schema:topology-geometry_v1",
          name: "topology-geometry_v1",
