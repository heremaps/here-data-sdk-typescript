...
describe("Stream Layer Client Read Data", async function () {
    ...
    beforeAll(async function () {
        // Tracing prints the whole MockServer log through this process and
        // slows the start up noticeably. A fatal JVM error still reaches
        // stderr, which mockserver-node always forwards.
                            ...
                            messages: [
                                {
                                    metaData: {
                                        partition: "314010583",
                                        checksum:
                                            "ff7494d6f17da702862e550c907c0a91",
                                        compressedDataSize: 152417,
                                        dataSize: 250110,
